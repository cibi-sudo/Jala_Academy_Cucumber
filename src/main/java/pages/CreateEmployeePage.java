...
public class CreateEmployeePage {
    ...
    public void clickFemaleRadio() {
        Helper.waitForElement(employeeButtonFemale);
        Helper.elementClick(employeeButtonFemale);
    }

    public void clickMaleRadio() {
        Helper.waitForElement(employeeButtonMale);
    ...
    public String inValidMobileNumberWarning() {
        Helper.waitForElement(employeeMobileNumber_Warning);
    ...
    public void saveWithValidCredentials(String firstName, String lastName, String email, String mobileNumber, String dob, String address, String country, String city) {
